...
GENERATE 20,000 RECORDS (PySpark)
...
3. SAVE AS CSV (FOR BRONZE INPUT)
df.write.mode("overwrite").option("header", True).csv("flipkart_raw_data")

4. WHAT ISSUES ARE PRESENT (IMPORTANT FOR STUDENTS)
...
Same order_id with different dates
